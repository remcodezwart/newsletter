<div class="container">
    ...
    <!-- login box on left side -->
        ...
        <form method="post" action="<?php echo Config::get('URL'); ?>register/register_action">
            ...
            <input type="text" name="user_email" placeholder="email address (a real address)" required="true" />
            ...
            <input type="password" name="user_password_repeat" pattern=".{6,}" required="true" placeholder="Repeat your password" autocomplete="off" />
